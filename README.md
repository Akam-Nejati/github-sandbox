# github-sandbox   
# 📥 Download Files via Comm it Message
...
- If no valid `download:` or `dowhjjnload-zip:` command is found in the commit message, the workflow will exit without doing anything
